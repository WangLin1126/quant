...
def main(test_flag=False, model_dir="models/", run_year=4, 
    ...
    for params in param_list:
        ...
        factor_name = "crossres_{}norm_c_{}_input_size_{}_prediction_size_{}_window_{}_hidden_dim_{}_num_layers_{}_{}_{}_{}year".format(norm, c, input_size , prediction_size , window , hidden_dim , num_layers , loss, freq, run_year)
        # Log
        log_path = log_dir + "crossres_{}norm_c_{}_input_size_{}_prediction_size_{}_window_{}_hidden_dim_{}_num_layers_{}_{}_{}_{}year.log".format(norm, c, input_size , prediction_size , window , hidden_dim , num_layers , loss , freq , run_year)
        ...
        for year in range(run_year):
            ...
            train_model_name = model_dir + "crossres_{}norm_train_begin_date_{}_c_{}_input_size_{}_prediction_size_{}_window_{}_hidden_dim_{}_num_layers_{}_{}_{}_{}year_train.pth".format(
                norm, train_begin_date, c, input_size , prediction_size , window , hidden_dim , num_layers , loss,freq, run_year)
            val_model_name = model_dir + "crossres_{}norm_train_begin_date_{}_c_{}_input_size_{}_prediction_size_{}_window_{}_hidden_dim_{}_num_layers_{}_{}_{}_{}year_val.pth".format(
                norm, train_begin_date, c, input_size , prediction_size , window , hidden_dim , num_layers , loss,freq, run_year)
            
            model = CrossGRUMLPRes(input_size, hidden_dim, num_layers, output_dim, dropout_rate, c, num_heads, device)
            model.to(device)
