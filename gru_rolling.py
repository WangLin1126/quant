...
def main(test_flag=False, model_dir="models/", run_year=4, 
    ...
    for params in param_list:
        ...
        for year in range(run_year):
            ...
            train_model_name = model_dir + "gruroll_{}norm_train_begin_date_{}_input_size_{}_prediction_size_{}_window_{}_hidden_dim_{}_num_layers_{}_{}_{}_train.pth".format(norm, train_begin_date,  input_size , prediction_size , window , hidden_dim , num_layers , loss,freq)
            val_model_name = model_dir + "gruroll_{}norm_train_begin_date_{}_input_size_{}_prediction_size_{}_window_{}_hidden_dim_{}_num_layers_{}_{}_{}_val.pth".format(norm, train_begin_date, input_size , prediction_size , window , hidden_dim , num_layers , loss,freq)
            ...
            logger.info('test_flag: {}, train_model_name: {},  \n \
                        ...
                        epochs: {}, lr: {}, batch_size: {}, device: {}, num_heads: {}'.format(
                                                                    ...
                                                                    input_size, hidden_dim, num_layers, output_dim,
                                                                    epochs, lr, batch_size, device, num_heads))
